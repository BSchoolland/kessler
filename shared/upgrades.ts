...
export function defaultMods(): UpgradeMods {
  return {
    reachMult: 1, damageMult: 1, knockbackMult: 1, dashSpeedMult: 1, maxHpBonus: 0, debrisExtra: 0,
    debrisDamageMult: 1, lifesteal: 0, aftershock: false, airControlMult: 1,
    voidBonusMult: 1, berserk: false, ammoMaxBonus: 0, slugDamageMult: 1, fuelMaxBonus: 0, fuelEfficiency: 1,
  };
}
...
export const FAMILIES: Family[] = [
  { key: "reach", name: "Long Arm", rarities: RARITIES, desc: (r) => `Melee reach +${pct(tier(r, 0.12, 0.2, 0.32))}`, apply: (m, r) => { m.reachMult *= 1 + tier(r, 0.12, 0.2, 0.32); } },
  { key: "damage", name: "Sharpened", rarities: RARITIES, desc: (r) => `Melee damage +${pct(tier(r, 0.12, 0.2, 0.32))}`, apply: (m, r) => { m.damageMult *= 1 + tier(r, 0.12, 0.2, 0.32); } },
  ...
  { key: "hp", name: "Vitality", rarities: RARITIES, desc: (r) => `Max HP +${tier(r, 8, 12, 20)}`, apply: (m, r, heal) => { m.maxHpBonus += tier(r, 8, 12, 20); heal(0, tier(r, 8, 12, 20)); } },
  ...
  { key: "fuel", name: "Fuel Tank", rarities: RARITIES, desc: (r) => `Fuel +${tier(r, 30, 50, 80)}`, apply: (m, r, heal) => { m.fuelMaxBonus += tier(r, 30, 50, 80); heal(0, 0); } },
  { key: "leech", name: "Leech", rarities: ["rare", "epic"], desc: (r) => `Heal ${pct(tier(r, 0, 0.06, 0.1))} of melee damage dealt`, apply: (m, r) => { m.lifesteal += tier(r, 0, 0.06, 0.1); } },
  ...
  { key: "magazine", name: "Magazine", rarities: RARITIES, desc: (r) => `Gun holds +${tier(r, 2, 3, 5)} rounds`, apply: (m, r, heal) => { m.ammoMaxBonus += tier(r, 2, 3, 5); heal(0, 0); } },
  ...
  { key: "berserk", name: "Berserk", rarities: ["epic"], once: true, desc: () => `+35% melee damage while under half HP`, apply: (m) => { m.berserk = true; } },
];
