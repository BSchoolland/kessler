...
| Aegis (w8) | walker behind a 140° shield that turns toward you at only 0.44 rad/s; slugs and the wave break on its front | the overhead sweep up close; launching over it and hitting the back |
